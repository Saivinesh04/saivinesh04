#Done by G.saivinesh, Abhishek Bkrishnan, Shubham Partap Singh
from tkinter import *
...
class FitnessCalculator:
    def __init__(self):
        ...
        Button(calculator,text="View Report",relief='ridge',bg='grey',fg='white',bd=2,command=show_results).grid(row=14,column=4,ipadx=4)
        Button(calculator,text="Save Report",relief='ridge',bg='grey',fg='white',bd=2,command=save_results).grid(row=14,column=4,ipadx=4)
